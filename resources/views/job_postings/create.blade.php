...
@section('createjob')
    @if (auth()->user()->level == 'admin')
        <form action="{{ route('job_postings.store') }}" method="POST">
            ...
            <!-- Syarat Pendidikan -->
            <div class="form-group">
                <label for="pendidikan" class="font-weight-bold">Syarat Pendidikan <span
                        class="text-danger">*</span></label>
            ...
            <!-- Syarat Pengalaman -->
            <div class="form-group">
                <label for="pengalaman" class="font-weight-bold">Syarat Pengalaman <span
                        class="text-danger">*</span></label>
                <div class="form-check">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="6-10tahun" name="pengalaman[]"
                        value="6-10 Tahun">
            ...
            <div class="form-group">
                <label for="levelPosisi" class="font-weight-bold">Level Posisi Pekerjaan <span
                        class="text-danger">*</span></label>
                <select class="form-control" id="levelPosisi" name="level_posisi" required>
            ...
            <!-- Tipe Pekerjaan -->
            <div class="form-group">
                <label for="tipePekerjaan" class="font-weight-bold">Tipe Pekerjaan <span
                        class="text-danger">*</span></label>
                <select class="form-control" id="tipePekerjaan" name="tipe_pekerjaan" required>
                    <option value="" disabled selected>Select</option>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="gaji" name="gaji" required>
                    <option value="" disabled selected>Select</option>
            ...
            <!-- Lokasi Pekerjaan -->
            <div class="form-group">
                <label for="lokasi" class="font-weight-bold">Lokasi Pekerjaan <span
                        class="text-danger">*</span></label>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="waktuBekerja" name="waktu_bekerja"
                    placeholder="Contoh: Senin - Jumat, 08:00 - 17:00 WIB">
            </div>

            <!-- CheckBox Tunjangan dan Insentif -->
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="is_tunjangan" id="optionalField">
            ...
            <div id="tunjangan" class="form-group" style="display: none;">
                ...
                <input type="text" class="form-control" id="tunjanganInput" name="tunjangan"
            ...
            <div id="insentif" class="form-group" style="display: none;">
                ...
                <input type="text" class="form-control" id="insentifInput" name="insentif"
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="remoteJobs" name="is_remote"
                        value="Remote jobs">
                    <label class="form-check-label" for="remoteJobs">Centang jika pekerjaan ini dikerjakan secara jarak
                        jauh
                        (remote jobs)</label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="pertanyaan1" name="pertanyaan_kandidat[]"
                        value="Berapa gaji bulanan yang kamu inginkan?">
                    <label class="form-check-label" for="pertanyaan1">Berapa gaji bulanan yang kamu inginkan?</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="pertanyaan2" name="pertanyaan_kandidat[]"
                        value="Apakah kamu bersedia bepergian untuk pekerjaan ini saat dibutuhkan?">
                    <label class="form-check-label" for="pertanyaan2">Apakah kamu bersedia bepergian untuk pekerjaan ini
                        saat
                        dibutuhkan?</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="pertanyaan3" name="pertanyaan_kandidat[]"
                        value="Apakah kamu bersedia bekerja di luar jam kerja biasa
                        saat dibutuhkan? (cth. akhir pekan, malam hari, hari libur nasional)">
                ...
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="pertanyaan4" name="pertanyaan_kandidat[]"
                        value="Produk Microsoft Office apa saja yang bisa kamu gunakan?">
                    <label class="form-check-label" for="pertanyaan4">Produk Microsoft Office apa saja yang bisa kamu
                        gunakan?</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="pertanyaan5" name="pertanyaan_kandidat[]"
                        value="Bahasa apa saja yang fasih kamu gunakan?">
                    <label class="form-check-label" for="pertanyaan5">Bahasa apa saja yang fasih kamu gunakan?</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" class="form-check-input" id="pertanyaan6" name="pertanyaan_kandidat[]"
                        value="Berapa lama waktu yang kamu butuhkan untuk memberi tahu perusahaanmu saat ini?">
                    <label class="form-check-label" for="pertanyaan6">Berapa lama waktu yang kamu butuhkan untuk memberi
                        tahu
