    ...
    <div class="app-wrapper"> <!--begin::Header-->
                ...
                <ul class="navbar-nav ms-auto"> <!--begin::Navbar Search-->
                    ...
                    <li class="nav-item dropdown user-menu"> <a href="#" class="nav-link dropdown-toggle"
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end"> <!--begin::User Image-->
                            ...
                            </li> <!--end::User Image--> <!--begin::Menu Body--> <!--end::Menu Body-->
                            <!--begin::Menu Footer-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark"> <!--begin::Sidebar Brand-->
            <div class="sidebar-brand"> <!--begin::Brand Link--> <a href="/" class="brand-link">
                    <!--begin::Brand Image--> <img src="{{ asset('icon/logo.png') }}" alt="Logo"
        ...
        <footer class="app-footer"> <!--begin::To the end-->
            ...
            <strong>
                ...
                <a href="" class="text-decoration-none">SMK TI GNC & LPKIA</a>.
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer> <!--end::Footer-->
